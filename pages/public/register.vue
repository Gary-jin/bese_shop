			...
			<view class="login-box y-f">
				...
				<view class="tip-box" @tap="onTcp">
					<label class="x-f">
						...
						<view class="">   
							我已阅读并遵守
							<text class="tcp" @tap="jump('/pages/public/richtext', { id: appcfgdata.store.user_agreement })">《用户协议》</text>
							与
							<text class="tcp" @tap="jump('/pages/public/richtext', { id: appcfgdata.store.privacy_agreement })">《隐私协议》</text>
						</view>
					</label>
				</view>
			</view>
