			...
			if (backgroundImage) {
				...
				switch (type) { //根据type获取背景图, 一般要改成request获取
					case 'invitePoster':
						...
						image = this.$IMG_URL + '/imgs/poster/invite_bg.png';
						break;
					case 'goodsPoster':
						// image = '/static/imgs/poster/goods_poster.png';
						image = this.$IMG_URL + '/imgs/poster/goods_poster.png';
						break;
					case 'grouponPoster':
						// image = '/static/imgs/poster/groupon_poster.png';
						image = this.$IMG_URL + '/imgs/poster/groupon_poster.png';
						break;
					default:
						image = '';
						break;
