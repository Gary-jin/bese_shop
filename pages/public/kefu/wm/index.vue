		...
		<view class="kefu_container">
			...
			<view class="content_wrapper" v-if="!showLeaveMessage" :style="{ height: 'calc(100vh - ' + writeBottom + 'px)' }">
				...
				<view class="project_list">
					...
					<view class="select_model_empty_goods" v-if="selectModelData.length <= 0"><text>没有更多记录了...</text></view>
				</view>
			</view>
		</view>
	</view>
...
export default {
	...
	methods: {
		...
		load: function() {
			...
			console.log(that.build_url('initialize') + "路径");
			uni.request({
