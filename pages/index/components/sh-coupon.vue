<template>
	<!-- 首页优惠券卡片 -->
	<view class="mx20">
	<view class="coupon-category-box pa20  mb20" v-if="detail.ids && couponList.length">
		<swiper class="coupon-swiper-box" @change="onSwiper" circular :autoplay="true" :interval="5000" :duration="2000">
			<swiper-item class="swiper-item" v-for="(c, index) in couponList" :key="c.id">
				<view class="tab-list x-c" @tap="jump('/pages/app/coupon/detail', { id: c.id })">
					<shopro-coupon :type="'noList'" :couponData="c" :state="0"></shopro-coupon>
				</view>
			</swiper-item>     
		</swiper>
	</view>
