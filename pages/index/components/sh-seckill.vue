<template>
	<!-- 限时抢购 -->
	<view class="seckill-goods pa20 mx20 mb20" v-if="showActivity">
		<view class="title-box x-bc" @tap="$Router.push('/pages/activity/seckill/list')">
...
export default {
	...
	created() {
		...
		let that = this
		uni.$on('delTabTimer',function(data){
...
// 今日必拼+限时抢购
.seckill-goods {
	background: linear-gradient(212deg, #FD7612 0%, #F93709 100%);
	border-radius: 20rpx;
	overflow: hidden;
