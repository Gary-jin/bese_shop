      ...
      >
        <!-- <u-waterfall v-model="liveList" ref="uWaterfall" v-if="liveList.length">
          <template v-slot:left="{ leftList }">
            <view v-for="live in leftList" :key="live.id"
              ><shopro-live-card :detail="live"></shopro-live-card
            ></view>
          </template>
          <template v-slot:right="{ rightList }">
            <view v-for="live in rightList" :key="live.id"
              ><shopro-live-card :detail="live"></shopro-live-card
            ></view>
          </template>
        </u-waterfall> -->
		
		<view class="x-bc" style="flex-wrap: wrap;padding: 0 20rpx;margin-top: 20rpx;">
			<shopro-live-card v-for="(item,index) in liveList" :key="index" :detail="item"></shopro-live-card>
		</view>
