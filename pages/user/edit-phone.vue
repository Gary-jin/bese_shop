		...
		<view class="form-box">
			<label>
				<view class="form-item flex align-center justify-between">
					...
					<input class="item-input flex-sub" v-if="fromType =='bind'" :disabled="'true'" type="number" v-model="phone" placeholder="请输入要绑定的新手机号" placeholder-class="pl-input" />
					<input class="item-input flex-sub" v-else  type="number" v-model="phone" placeholder="请输入要绑定的新手机号" placeholder-class="pl-input" />
				</view>
			</label>
			<view class="form-item flex align-center justify-between">
				<label>
