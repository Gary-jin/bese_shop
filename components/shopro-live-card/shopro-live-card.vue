<template>
	<view class="sp-live-card" :style="{ width: wh + 'rpx' }">
		<view class="live-content" @tap="goRoom" :style="{ width: wh + 'rpx' }">
			...
			<u-lazy-load class="item-cover" :image="detail.share_img" :loading-img="loadingTmg" :error-img="errorImg" img-mode="aspectFill"></u-lazy-load>
...
export default {
	...
	mounted() {
		...
		// 	that.getLiveStatus();
		// }, 60000);
		// uni.$on('delLiveTimer',function(data){
