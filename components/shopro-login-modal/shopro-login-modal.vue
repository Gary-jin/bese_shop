<template>
	<!-- #ifndef MP-WEIXIN  -->
	<view class="cu-modal" v-if="showLogin && !screenShot" :class="[{ show: showLogin }, modalType]" cathctouchmove @tap="hModal">
		<view class="cu-dialog" @tap.stop style="background: none;overflow: visible;">
			<view class="modal-box">
				...
				<view class="btn-box y-f">
					...
					<button class="cu-btn close-btn" @tap="hModal">取消</button>
				</view>
			</view>
		</view>
	</view>
	...
	<view class="force-login-wrap" v-if="forceOauth || showLogin">
		...
		<view class="force-login__content y-f">
			...
			<button class="cu-btn author-btn" @click="getToken" >授权并查看</button>
