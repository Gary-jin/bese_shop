<template>
	<view class="wallet_class" :class="type?'wallet_class_kq':'wallet_class_gb'" v-if="topayPwds">
		...
		<view v-if="payType==='two'" class="wallet_content2" :class="type?'wallet_kq':'wallet_gb'">
			<!-- 头部 -->
			<view style="width: 750rpx;height: 100vh;" @tap="toCancel" v-if="keep"></view>
			<view class="wallet_content_tb">
				<view class="hader" :style="'color:'+ titeColor">
					<view style="width: 50rpx;">
					</view>
					<view
						style="width: 42rpx; position: absolute; left: 40rpx; text-align: center; font-weight: 600; line-height: 48px; font-size: 36rpx;"
						@tap="toCancel">
						X
					</view>
					<view style="text-align: center; font-weight: 600; font-size: 34rpx; line-height: 48px;">请输入支付密码
					</view>
				...
				<view class="money">
					<text style="font-size: 34rpx; font-family: PingFangSC-Semibold, PingFang SC;font-weight: 600;color: #333333;line-height: 48rpx;">￥</text>
					<text style="font-size: 70rpx;font-family: DINAlternate-Bold, DINAlternate;font-weight: bold;color: #333333;line-height: 82rpx;letter-spacing: 1rpx;">{{money}}</text>
				...
				<view class="forget_text">
					<view style="width: 630rpx; text-align: center;
					text-decoration:underline;" @tap="forget">忘记密码?</view>
				</view>
			</view>
				...
				<view class="capsule">
					<view class="jp_hea" :style="keyImg?'':'background-color: #f5f5f5'">
						...
						<view :class="keyType=='one'?'jq_key':'jq_key2'">
							...
							<view @touchend="backspace()" class="keyboard cuIcon-backdelete text-gray" :style="keyImg?'':'background-color: #fff'"
								data-char="×" hover-class="click_hover"></view>
						</view>
					</view>
				</view>
...
<script>
	export default {
		...
		mounted() {
			...
			this.width2 = (630 - 90) / this.places
			this.payPwdGrid = []
