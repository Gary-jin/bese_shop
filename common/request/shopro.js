...
export default {
	...
	api:{
		...
		userAddrInfoSubmit: {
			url: 'api/lucky_draw/userAddrInfoSubmit',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '领奖接口  ',
		...
		secondhandGoodsList: {
			url: 'api/secondhand_goods/lists',
			auth: true,
			method: 'GET',
			isnew:true //是否是新接口
			// desc: '易货 商品列表 ',
		...
		sCyGoodsList: {
			url: 'api/secondhand_category/goodsCategory',
			auth: true,
			method: 'GET',
			isnew:true //是否是新接口
			// desc: '易货 商品分类 ',
		...
		sCyDetail: {
			url: 'api/secondhand_goods/detail',
			auth: true,
			method: 'GET',
			isnew:true //是否是新接口
			// desc: '易货 商品详情 ',
		...
		sCyGoodsPost: {
			url: 'api/secondhand_goods/goodsPost',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货 商品发布/编辑已发 ',
		...
		sCyChangeStatus: {
			url: 'api/secondhand_goods/changeStatus',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货 更新商品状态',
		...
		sCyFavorite: {
			url: 'api/secondhand_goods/favorite',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货  收藏/取消收藏商品',
		...
		sCyFavoriteList: {
			url: 'api/secondhand_goods/favoriteList',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货  收藏/取消收藏商品',
		...
		sCyCreateOrder: {
			url: 'api/secondhand_order/createOrder',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货  订单提交',
		...
		sCyOrderDetail: {
			url: 'api/secondhand_order/detail',
			auth: true,
			method: 'GET',
			isnew:true //是否是新接口
			// desc: '易货  订单提交',
		...
		sCyOrderList: {
			url: 'api/secondhand_order/index',
			auth: true,
			method: 'GET',
			isnew:true //是否是新接口
			// desc: '易货  订单列表',
		...
		sCyOrderCancel: {
			url: 'api/secondhand_order/cancel',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货  取消订单',
		...
		sCyOrderDel: {
			url: 'api/secondhand_order/delete',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货  删除订单',
		...
		sCyConfirm: {
			url: 'api/secondhand_order/confirm',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货  确认订单',
		...
		sCyStockUp: {
			url: 'api/secondhand_order/stockUp',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货  订单备货',
		...
		sCyOrderEXP: {
			url: 'api/secondhand_order/getExpressList',
			auth: true,
			method: 'GET',
			isnew:true //是否是新接口
			// desc: '易货  快递公司列表',
		...
		sCySale: {
			url: 'api/secondhand_order/afterSaleReasons',
			auth: true,
			method: 'GET',
			isnew:true //是否是新接口
			// desc: '易货  投诉原因列表',
		...
		sCyafterSale: {
			url: 'api/secondhand_order/afterSale',
			auth: true,
			method: 'POST',
			isnew:true //是否是新接口
			// desc: '易货   售后提交',
